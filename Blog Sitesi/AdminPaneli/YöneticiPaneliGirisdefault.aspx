<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YöneticiPaneliGiris.aspx.cs" Inherits="Blog_Sitesi.AdminPaneli.YöneticiPaneliGiris" %>
    ...
    <form id="form1" runat="server">
         <div style="height:50px; background-color:#0094ff">
            ...
            <div style="float:left;width:184px; margin-top:20px;">
                ...
                <asp:Button ID="btn_enter" runat="server" Text="Enter" BackColor="White" ForeColor="#000000" Width="188px" Height="44px" />
