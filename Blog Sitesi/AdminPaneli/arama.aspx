<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPaneli/Kullanıcı.Master" AutoEventWireup="true" CodeBehind="arama.aspx.cs" Inherits="Blog_Sitesi.AdminPaneli.arama" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     &nbsp;&nbsp;&nbsp;
    <div style="width:690px;height:auto;margin:0 auto;"></div>
    <asp:DataList ID="dtl_ara" runat="server" Width="690px">
        <ItemTemplate>
