<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPaneli/Kullanıcı.Master" AutoEventWireup="true" CodeBehind="kategoridetay.aspx.cs" Inherits="Blog_Sitesi.kategoridetay" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
    ...
    <asp:DataList ID="dtl_kategori" runat="server" Width="690px">
        <ItemTemplate>
            <div style="width:690px;margin:0 auto;height:auto;">
                ...
                <div style="width:690px;float:left;height:20px;line-height:20px;font-size:12px,; background-color: #00CCFF;">
                    ...
                    <div style="width:auto; height:20px;float:left;margin-right:15px;">
                        ...
                        <img alt="" class="auto-style6" src="temalar/tıklanma.png" />
